                  ...
                  <table id="userTable" class="table table-bordered table-striped">
                      ...
                      @foreach($organizations as $organization)
                          <tr>
                              ...
                              <td>
                                  @if($organization->status == 1)
                                      <button class="btn btn-warning my-1" id="{{ $organization->id }}" onclick="blockUser(this.id)">Block</button>
                                  @else
                                      <button class="btn btn-success my-1" id="{{ $organization->id }}" onclick="activeUser(this.id)">Active</button>
                                  @endif

                                  <form action="{{ route('deleteUser',$organization->id) }}" method="post">
                                      @csrf
                                      @method('DELETE')
